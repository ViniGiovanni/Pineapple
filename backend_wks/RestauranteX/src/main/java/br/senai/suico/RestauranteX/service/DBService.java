...
public class DBService {
	...
	/*	
		Cliente c1= new Cliente(null,"Regina Costa","regina@gmail.com" ,passwordEncoder.encode("123"),"USER");
		Cliente c2= new Cliente(null,"Luan Silva","luan@gmail.com",passwordEncoder.encode("123"),"USER");
		Cliente c3= new Cliente(null,"Administrador","admin@gmail.com",passwordEncoder.encode("123"),"ADMIN");
		
		var c4 = Cliente.builder().nome("Tarrou").email("tarrou@gmail.com").senha(passwordEncoder.encode("123")).roles("ADMIN,USER").build();
		*/
